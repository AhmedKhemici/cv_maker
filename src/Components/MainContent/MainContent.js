...
const MainContent = (props) => {
  return (
    <div className="MainContent" > 
      ...
      {props.main_content.educations !== undefined && <Educations educations={props.main_content.educations} title={props.language.educations} project={props.language.project}/>}
    </div>
  )
}
